...
$result = $mysqli->query("SELECT posts.id, posts.title, posts.content, posts.authorid, users.first_name, users.last_name FROM posts INNER JOIN users ON posts.authorid=users.id WHERE id='{$_GET['id']}' LIMIT 1;");
